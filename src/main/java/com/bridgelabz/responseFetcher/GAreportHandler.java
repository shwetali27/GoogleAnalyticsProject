...
public class GAreportHandler {
	...
	public GetReportsResponse getReport(AnalyticsReporting service, GaReportInputModel gaReportInputModel,String pagetoken,List<ReportRequest> requests)
			throws IOException {
		...
		List<DimensionFilterClause> dmfilterclauselist = new ArrayList<DimensionFilterClause>();
